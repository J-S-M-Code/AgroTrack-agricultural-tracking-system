...
class AnimalMovementTest {
    ...
    void setUp() {
        ...
        originLot = Lot.create("Lote 1", 10.5, SoilType.CLAYEY, LotType.AGREICULTURAL, "Desc", lotPolygon, farm);
        
        registeredBy = User.create("Pepe", "Perez", "12345678", "555-1234", "Addr", "pepe@test.com", new Password("Password987!"), UserRole.WORKER);
    }
